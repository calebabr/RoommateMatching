          ...
          <>
            ...
            <div style={S.inputGroup}>
              ...
              <div style={{ position: 'relative' }}>
                <input style={{ ...S.input, paddingRight: 40 }} placeholder="Choose a password" type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} />
                <button
                  type="button"
