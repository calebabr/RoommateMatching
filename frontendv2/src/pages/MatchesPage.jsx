    ...
    <div style={{ backgroundColor: Colors.bg, minHeight: '100%' }}>
      ...
      {matches.length === 0 ? (
        <div style={S.centered}>
          ...
          <p style={S.emptySub}>When you and someone like each other, you'll see them here.</p>
        </div>
      ) : (
...
const S = {
  ...
  card:       { backgroundColor: Colors.bgCard, borderRadius: Radius.lg, padding: 20, marginTop: 16, border: `1px solid ${Colors.success}` },
